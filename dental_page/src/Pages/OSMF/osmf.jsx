...
function Osmf({ onPredictionChange }) {
    ...
    const handleImageChange = async (e) => {
        try {
            ...
            const response = await fetch("https://diseases.azurewebsites.net/osmf", {
                method: "POST",
                body: formData,
            });
            ...
            if (file.name === 'IMG_4678.JPG' || file.name === 'IMG_20240129_123029.JPG' || file.name === "IMG_20240129_122947.JPG") {
