...
function Gingi({onPredictionChange}){
    ...
    const handleImageChange = async (e) => {
        try {
            ...
            const response = await fetch("https://diseases.azurewebsites.net/gingivitis", {
                method: "POST",
                body: formData,
            });
            ...
            console.log("Gingivitis Detection Result:", data.result);
    ...
    return(
        <div className="text-center px-8">
            <h1 className="text-gray-800">Gingivitis Detection</h1>
